    ...
    <div className='missionVision'>
      ...
      <div className='missionVision__container'>
        ...
        <div className='missionVison__details'>
             ...
             <p>
             Reach out human is built around the idea that the unprivileged should be able to access the facilities, including what they eat, where they stay, why they learn and what they do. We empower the less fortunate to use their spaces, passions, and talents to become independent and rely on themselves.</p>
