...
function ChangesLives() {
  return (
    <div className='changesLives'>
        ...
        <p className='changesLives__subHeadLine'> Happy moments for disadvantaged people. We want everyone <br/>to have the financial and mental resources and support</p>
